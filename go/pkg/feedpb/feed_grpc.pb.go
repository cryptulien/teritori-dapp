...
type FeedServiceClient interface {
	...
	BotAnswer(ctx context.Context, in *BotAnswerRequest, opts ...grpc.CallOption) (*BotAnswerResponse, error)
}
...
func (c *feedServiceClient) BotAnswer(ctx context.Context, in *BotAnswerRequest, opts ...grpc.CallOption) (*BotAnswerResponse, error) {
	out := new(BotAnswerResponse)
	err := c.cc.Invoke(ctx, "/feed.v1.FeedService/BotAnswer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FeedServiceServer interface {
	...
	BotAnswer(context.Context, *BotAnswerRequest) (*BotAnswerResponse, error)
...
func (UnimplementedFeedServiceServer) BotAnswer(context.Context, *BotAnswerRequest) (*BotAnswerResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BotAnswer not implemented")
}
...
func _FeedService_BotAnswer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BotAnswerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FeedServiceServer).BotAnswer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/feed.v1.FeedService/BotAnswer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FeedServiceServer).BotAnswer(ctx, req.(*BotAnswerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FeedService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _FeedService_BotAnswer_Handler,
		},
	},
